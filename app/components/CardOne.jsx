        ...
        <div className="cards card-1">
          ...
          <div className="card-text">
            ...
            <p>
              ...
              barista skills, perfect your craft, and start your coffee journey
              today!
            </p>
        ...
        <div className="cards card-2">
          <div className="card-text">
            ...
            <p>
              ...
              coverage to ensure you gain all the necessary skills. Perfect your
              coffee-making techniques and build a strong foundation for a
              successful barista career with us!
            </p>
            <Link href="#" className="card-btn">
              Get Started
            </Link>
        ...
        <div className="cards card-3">
          ...
          <div className="card-text">
            ...
            <p>
              ...
              operating commercial machines to mastering latte art, ensuring
              your hotel serves exceptional coffee with every cup.
            </p>
            <Link href="#" className="card-btn">
              Get Started
            </Link>
